...
class CheckLectures:
    ...
    def check(self):
        ...
        for i in range(1, count_lecture + 1):
            ...
            lecture_name = main_page.find_element(By.XPATH, f'./li[{i}]/div/a/div/div[2]/h3').text
            self.my_dict[lecture_name] = []
                ...
                for file in ul_list[0].find_elements(By.TAG_NAME, 'li'):
                    ...
                    if (lecture_list[now_index] in my_text) and ("동영상" in my_text):
                        ...
                        if (from_d <= time_now) and (time_now <= until_d):
                            self.my_dict[lecture_name].append(lecture_list[now_index])
